...
import { Bell, ChevronDown, ListTodo, LogOut, Settings } from "lucide-react";
import ThemeToggle from "./theme-toggle";
import type { Member } from "../lib/workflow";

export default function ProfileMenu({ me, navigate, signOut }: {
  me: Member; navigate: (view: "work" | "settings" | "notifications") => void; signOut?: () => void;
}) {
  ...
  const go = (view: "work" | "settings" | "notifications") => { setOpen(false); navigate(view); };
